    ...
    public class ChildViewController : Controller
    {
       ...
       // [OutputCache(Duration = ClassExten.timeCacheChild, VaryByParam = "lang", VaryByCustom = "browser")]
        public ActionResult ChildHome(string lang)
        {
            ...
            var allPro = db.Products.Where(u => u.pLang.Equals(lang) && u.active == true).ToList();
            ...
            var catepro = allCate.Where(u => u.cateLang.Equals(lang) && u.cateType == ClassExten.typeCareer && u.cateActive == true && u.catepar_id.Equals("-1")).ToList();
        ...
        public ActionResult PageProLeft(string lang, string typePage)
        {
            ...
            var catepro = db.Categorys.Where(u => u.cateLang.Equals(lang) && u.cateType == ClassExten.typeCareer && u.cateActive == true && u.catepar_id.Equals("-1")).ToList();
            ViewBag.catepro = catepro;
