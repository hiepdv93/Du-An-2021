...
namespace NTSPRODUCT.Controllers
{
    public class CategorysController : Controller
    {
        ...
        {
             all = (from a in db.Categorys.AsNoTracking()
        ...
        public ActionResult AddCatepro(FormCollection fr)
        {
            try
            {
                ...
                string cateNameSub = fr["cateNameSub"];
                ...
                cate.cateNameSub = cateNameSub;
                cate.cateImageHome = fr["cateImageHome"];
                cate.cateImageOther = fr["cateImageOther"];
                cate.cateImage = fr["cateImage"];
                cate.cateDescription = fr["cateDescription"];
                cate.cateDescriptionShot = fr["cateDescriptionShot"];
