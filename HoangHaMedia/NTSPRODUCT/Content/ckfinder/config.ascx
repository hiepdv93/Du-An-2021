...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        type = ResourceType.Add("AdvI");
        type.Url = BaseUrl + "advi/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "advi/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf", "bmp", "gif", "jpeg", "jpg", "png", "ico" };
        type.DeniedExtensions = new string[] { };
	
        type = ResourceType.Add("Library");
        type.Url = BaseUrl + "library/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "library/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf", "bmp", "gif", "jpeg", "jpg", "png", "ico" };
        type.DeniedExtensions = new string[] { };

		type = ResourceType.Add("Category");
        type.Url = BaseUrl + "category/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "category/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf", "bmp", "gif", "jpeg", "jpg", "png", "ico" };
        type.DeniedExtensions = new string[] { };
		...
		type = ResourceType.Add("Other");
        type.Url = BaseUrl + "other/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "other/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf", "bmp", "gif", "jpeg", "jpg", "png", "ico" };
        type.DeniedExtensions = new string[] { };
	}
