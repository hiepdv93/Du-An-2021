    ...
    public class ConfigController : Controller
    {
        ...
        public ActionResult Index(FormCollection f)
        {
            try
            {
                ...
                data.IntroHomeDes = f["IntroHomeDes"];
                data.IntroHomeContent = f["IntroHomeContent"];
                data.IntroHomeImg = f["IntroHomeImg"];
                data.thongDiepQuaTang = f["thongDiepQuaTang"];
                data.chinhSachQuaTang = f["chinhSachQuaTang"];
                data.numberThueHT = int.Parse(f["numberThueHT"]);
