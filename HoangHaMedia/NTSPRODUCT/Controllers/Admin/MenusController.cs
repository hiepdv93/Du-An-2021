...
namespace NTSPRODUCT.Controllers
{
    public class MenusController : Controller
    {
        ...
        public ActionResult Update(string id)
        {
            ...
            if (menu.mtype == 3)
            {
                ...
                if (mang.Length == 3)
                {
                    ...
                    {
                        //la san phâm
                        var cate = db.Categorys.FirstOrDefault(u => u.cateType == ClassExten.typeProduct && u.cateKey == keycate);
                        if (cate != null)
                        {
                            idcateLK = cate.id;
                        }
        ...
        public ActionResult NhomThuonghieu()
        {
            var cate = db.Brands.OrderBy(u => u.numberOder).ToList();
            return PartialView(cate);
        }
