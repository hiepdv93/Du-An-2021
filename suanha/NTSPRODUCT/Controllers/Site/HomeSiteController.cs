...
namespace NTSPRODUCT.Controllers.Site
{
    public class HomeSiteController : Controller
    {
        ...
        public ActionResult SiteMap()
        {
            ...
            //danh muc
            var cateP = db.Categorys.Where(s => s.cateLang.Equals(lang) && s.cateActive == true && s.cateType == ClassExten.typeCareer).OrderByDescending(s => s.cateOrder).ToList();
            ...
            //phong dao tao
            var dep = db.Departments.Where(s => s.lang.Equals(lang) && s.status == Constants.Active).OrderByDescending(s => s.dOrder).ToList();
            foreach (var item in dep)
            {
                text += "<url>" + Environment.NewLine + "\t<loc>http://" + urlHost + "/phong-dao-tao/" + item.dkey + "</loc>" + Environment.NewLine + "\t<changefreq>" + changeFreq + "</changefreq>" + Environment.NewLine + "\t<priority>" + otherPriority + "</priority>" + Environment.NewLine + "</url>" + Environment.NewLine;
            }
            //giang vien
            var teacher = db.Teachers.Where(s => s.lang.Equals(lang) && s.status == true).OrderByDescending(s => s.tOrder).ToList();
            foreach (var item in teacher)
            {
                text += "<url>" + Environment.NewLine + "\t<loc>http://" + urlHost + "/giang-vien/" + item.tkey + "</loc>" + Environment.NewLine + "\t<changefreq>" + changeFreq + "</changefreq>" + Environment.NewLine + "\t<priority>" + otherPriority + "</priority>" + Environment.NewLine + "</url>" + Environment.NewLine;
            }
            //lien he
