...
for (var i = 1; i <= 4; i++) {
    if ($('#clockdiv_' + i).length) {
        dateToStr = $('#dateTo_' + i).val().split(':');
       
        dateTo = new Date(parseInt(dateToStr[0]), parseInt(dateToStr[1])-1, parseInt(dateToStr[2]), parseInt(dateToStr[3]), parseInt(dateToStr[4]), parseInt(dateToStr[5]));
